...
//         }}
//       >
//         <div className="max-w-[1008px] space-y-[54px] flex flex-col p-4 md:p-0 text-center md:text-left">
//          <h1 className="font-[700] text-[22px] md:text-[48px] leading-[40px] md:leading-[68px] font-Playfair text-[#047F15] mt-[6rem] md:mt-0 text-center md:text-left">
//   Door, Plywood, Laminate sheets & furniture related items suppliers
// </h1>
...
const Banner1 = () => {
    ...
    <>
      ...
      >
        <div className="max-w-[1008px] space-y-[54px] flex flex-col p-4 md:p-0 text-center md:text-left relative z-10">
         <h1 className="font-[700] text-[22px] md:text-[48px] leading-[40px] md:leading-[68px] font-Playfair text-[#fff] mt-[6rem] md:mt-0 text-center md:text-left drop-shadow-lg">
  Door, Plywood, Laminate sheets & furniture related items supplier
          ...
          <p className="font-[400] text-[18px] md:text-[24px] leading-[23px] md:leading-[32.68px] font-OpenSans text-[#fff] drop-shadow-lg">
            Explore different categories. Find the best deals.
          </p>
        </div>
      </div>
